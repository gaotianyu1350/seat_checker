...
def main():
    ...
    # Data loading code
    traindir = '../data-center_room/train_pytorch'
    valdir = traindir
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=args.workers, pin_memory=_use_cuda, sampler=train_sampler)
    ...
    val_loader = torch.utils.data.DataLoader(
        ...
        num_workers=args.workers, pin_memory=_use_cuda)
